...
If you want to require a logged in user, you can need to add a few
snippets of code to the example below.

. Add the `authenticationOptions` to the `configuratorOptions` object:
```ts
const options = {
